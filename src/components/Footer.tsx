      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col gap-24 md:gap-32">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 border-t border-white/20 pt-12">
          ...
          <div className="flex flex-wrap gap-12 md:gap-16">
            ...
            <div className="flex flex-col gap-4">
              <span className="text-[10px] md:text-xs font-mono uppercase tracking-widest text-gray-500">Milan, Italy</span>
              <div className="flex flex-col gap-1">
                <span className="text-[10px] md:text-xs font-mono uppercase tracking-widest text-gray-500">Office Hours</span>
                <span className="text-[10px] md:text-xs font-mono uppercase tracking-widest text-gray-500">M-F, 9 AM - 6 PM</span>
              </div>
            </div>
          </div>
        </div>
