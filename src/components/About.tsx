    ...
    <section id="about" className="py-24 md:py-32 w-full bg-white text-[#131313]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
        ...
        <div className="md:col-span-2 flex flex-col gap-12 md:gap-16">
          ...
          >
          Interaction Designer with a background in digital and UI/UX design, working end-to-end from research to high-fidelity prototyping. Somtimes I also write the code behind my designs (passion for CSS and HTML... and a bit of React).
          </motion.p>
